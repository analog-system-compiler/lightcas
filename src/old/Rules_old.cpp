...
const char CRules::m_AlgebraRuleString[] =
  ...
  "POLY_POW(a^-CONST(b),v)  := POLY(a,v)^-b;"
  //"POLY_POW(a^b,1)          := TED(0,SIMPLIFY(a)^b)/TED(0,1);"
  "POLY_POW(a^b,v)          := TED(0,a^b)/TED(0,1);"
  "POLY_POW(a,v)            := POLY(a,v);"
#else
  "POLY(a^CONST(b),v)   := POLY(a,v)^b;"
  "POLY(a^-CONST(b),v)  := POLY(a,v)^-b;"
  "POLY(a^b,v)          := TED(0,SIMPLIFY(a)^b)/TED(0,1);"
  //"POLY(a^b,v)          := POLY(a^SIMPLIFY(b),1);"
#endif
  "POLY(COS(a),1)           := TED(0,COS( SIMPLIFY(a)))/TED(0,1);"
  "POLY(SIN(a),1)           := TED(0,SIN( SIMPLIFY(a)))/TED(0,1);"
  "POLY(TAN(a),1)           := TED(0,TAN( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ACOS(a),1)           := TED(0,ACOS( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ASIN(a),1)           := TED(0,ASIN( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ATAN(a),1)           := TED(0,ATAN( SIMPLIFY(a)))/TED(0,1);"

  "POLY(COSH(a),1)           := TED(0,COSH( SIMPLIFY(a)))/TED(0,1);"
  "POLY(SINH(a),1)           := TED(0,SINH( SIMPLIFY(a)))/TED(0,1);"
  "POLY(TANH(a),1)           := TED(0,TANH( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ACOSH(a),1)           := TED(0,ACOSH( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ASINH(a),1)           := TED(0,ASINH( SIMPLIFY(a)))/TED(0,1);"
  "POLY(ATANH(a),1)           := TED(0,ATANH( SIMPLIFY(a)))/TED(0,1);"

  "POLY(EXP(a),1)           := TED(0,EXP( SIMPLIFY(a) ))/TED(0,1);"
  "POLY(FACT(a),1)          := TED(0,FACT(SIMPLIFY(a) ))/TED(0,1);"
  "POLY(LOG(a),1)           := TED(0,LOG( SIMPLIFY(a) ))/TED(0,1);"
  "POLY(LOG10(a),1)           := TED(0,LOG10( SIMPLIFY(a)))/TED(0,1);"
  "POLY(VECT(a),1)           := TED(0,VECT( SIMPLIFY(a) ))/TED(0,1);"

  "POLY(EQ(a,b),1)           := TED(0,EQ( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(NEQ(a,b),1)           := TED(0,NEQ( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(GT(a,b),1)           := TED(0,GT( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(GTE(a,b),1)           := TED(0,GTE( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(LT(a,b),1)           := TED(0,LT( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(LTE(a,b),1)           := TED(0,LTE( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(SHL(a,b),1)           := TED(0,SHL( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(SHR(a,b),1)           := TED(0,SHR( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  "POLY(CONCAT(a,b),1)          := TED(0,CONCAT( SIMPLIFY(a), SIMPLIFY(b)))/TED(0,1);"
  ...
  "SOLVE2(TED(TED(a,b),c)/e,v)        := { SIMPLIFY((-b-SQRT(b^2-4*a*c))/(2*a)), SIMPLIFY((-b+SQRT(b^2-4*a*c))/(2*a)) };"
  "SOLVE2(TED(a,b)/e,v)               := SIMPLIFY((-b)/a);"
