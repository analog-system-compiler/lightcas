...
class CElement
{
  ...
  // *INDENT-OFF* 
    ...
    void SetEvalFunct( void ( CEvaluator::*eval_ptr )() )     {      m_EvalFunct = eval_ptr;    }
    void ( CEvaluator::*GetEvalFunction() )()    {      return m_EvalFunct;    }
    void SetOperandNb( unsigned operand_nb )    { m_Type = ELEM_FUNCT;     m_Function.SetParameterNb( operand_nb );    }
    ...
    bool IsNumeric() const {      return m_EvalFunct != NULL;    }
